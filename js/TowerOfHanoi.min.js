var Disc = function (a) {
    ...
    var b = this.options;
    this.id = b.id;
    this.el = jQuery('<div id="disc-' + b.id + '" title="Disc ' + b.id + '" class="disc"></div>');
    this.width = b.width;
...
var Peg = function (a) {
    ...
    this.id = a + 1;
    this.label = jQuery('<div class="peg-label">' + this.alpha[a] + "</div>");
...
var Game = function (b) {
    ...
    this.onPause = this.options.onPause || function (f) {};
    this.onFreeze = this.options.onFreeze || function (f) {};
...
Game.prototype.resume = function () {
    ...
    for (p in this.pegs) {
        if (this.pegs[p].discs.length > 0) {
            var a = this.pegs[p].discs[0];
            a.getDisc().draggable("enable")
        }
